...
exports.default = function (program) {
  program.command('vscode [project-dir]').description('Runs Expo on top of an existing packager. Run `react-native start` before calling this command.').option('-p, --port [number]', 'Port of existing packager').asyncActionProjectDir(action);
};
