...
exports.default = function (program) {
  program.command('test-schema [project-dir]', null, { noHelp: true }).option('-s, --schema [path]', 'Validate the current directory against the given schema').asyncActionProjectDir(action, true /* skip project validation */);
};

module.exports = exports['default'];
//# sourceMappingURL=../__sourcemaps__/exp_commands/test-schema.js.map
