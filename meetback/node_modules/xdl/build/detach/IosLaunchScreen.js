...
let configureLaunchAssetsAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (context, intermediatesDirectory) {
    ...
    if (context.type === 'user') {
      ...
      if ((_fsExtra || _load_fsExtra()).default.existsSync(generatedUnnecessaryNib)) {
        (_rimraf || _load_rimraf()).default.sync(generatedUnnecessaryNib);
      }
    }
  });
...
const logger = (_Logger || _load_Logger()).default.withFields({ buildPhase: 'configuring NSBundle' });
