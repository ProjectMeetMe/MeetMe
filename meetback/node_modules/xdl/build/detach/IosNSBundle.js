...
let configureAsync = (() => {
  var _ref7 = _asyncToGenerator(function* (context) {
    ...
    yield rimrafAsync(intermediatesDirectory);
    ...
    try {
      ...
      if (context.type === 'user') {
        ...
        try {
          yield (_AssetBundle || _load_AssetBundle()).bundleAsync(context.data.manifest.bundledAssets, supportingDirectory, context.data.manifest.sdkVersion === '24.0.0');
        } catch (e) {
      ...
      yield Promise.all([_cleanPropertyListBackupsAsync(context, supportingDirectory), rimrafAsync(intermediatesDirectory)]);
    }
  });

  return function configureAsync(_x13) {
...
const rimrafAsync = (0, (_util || _load_util()).default)((_rimraf || _load_rimraf()).default);
