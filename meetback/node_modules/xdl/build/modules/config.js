...
const expoSdkUniversalModulesConfigs = expoSdkUniversalModules.map((_ref) => {
  let { config, podName, libName, sdkVersions, isNativeModule } = _ref,
      params = _objectWithoutProperties(_ref, ['config', 'podName', 'libName', 'sdkVersions', 'isNativeModule']);
