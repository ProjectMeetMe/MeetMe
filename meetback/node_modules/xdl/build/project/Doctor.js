  ...
  var _ref = _asyncToGenerator(function* (projectRoot) {
    try {
      ...
      if ((_semver || _load_semver()).default.lt(npmVersion, MIN_NPM_VERSION) || _isNpmVersionWithinRanges(npmVersion, BAD_NPM_VERSION_RANGES)) {
        (_ProjectUtils || _load_ProjectUtils()).logError(projectRoot, 'expo', `Error: You are using npm version ${npmVersion}. We recommend the latest version ${CORRECT_NPM_VERSION}. To install it, run 'npm i -g npm@${CORRECT_NPM_VERSION}'.`, 'doctor-npm-version');
        return WARNING;
...
let _validateExpJsonAsync = (() => {
  var _ref5 = _asyncToGenerator(function* (exp, pkg, projectRoot, allowNetwork) {
    if (!exp || !pkg) {
  ...
  return function _validateExpJsonAsync(_x11, _x12, _x13, _x14) {
    return _ref5.apply(this, arguments);
  };
})();

let _validateReactNativeVersionAsync = (() => {
  var _ref6 = _asyncToGenerator(function* (exp, pkg, projectRoot, sdkVersions, sdkVersion) {
  ...
  return function _validateReactNativeVersionAsync(_x15, _x16, _x17, _x18, _x19) {
...
let _validateNodeModulesAsync = (() => {
  ...
  return function _validateNodeModulesAsync(_x20) {
...
let validateLowLatencyAsync = exports.validateLowLatencyAsync = (() => {
  ...
  return function validateLowLatencyAsync(_x21) {
...
let validateWithNetworkAsync = exports.validateWithNetworkAsync = (() => {
  ...
  return function validateWithNetworkAsync(_x22) {
    return _ref9.apply(this, arguments);
  };
})();

let validateAsync = (() => {
  var _ref10 = _asyncToGenerator(function* (projectRoot, allowNetwork) {
  ...
  return function validateAsync(_x23, _x24) {
...
let getExpoSdkStatus = exports.getExpoSdkStatus = (() => {
  ...
  return function getExpoSdkStatus(_x25) {
