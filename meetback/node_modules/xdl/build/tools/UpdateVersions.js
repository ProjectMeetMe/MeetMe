...
exports.updateTurtleVersionAsync = exports.updateAndroidApk = exports.updateIOSSimulatorBuild = exports.updateSdkVersionsAsync = undefined;
...
let updateTurtleVersionAsync = exports.updateTurtleVersionAsync = (() => {
  var _ref4 = _asyncToGenerator(function* (sdkVersion, platform) {
    const platforms = platform === 'both' ? ['android', 'ios'] : [platform];
    const versions = yield (_Versions || _load_Versions()).versionsAsync();
    platforms.forEach(function (p) {
      return (_lodash || _load_lodash()).default.set(versions, ['turtleSdkVersions', p], sdkVersion);
    });
    yield (_Versions || _load_Versions()).setVersionsAsync(versions);
  });

  return function updateTurtleVersionAsync(_x11, _x12) {
